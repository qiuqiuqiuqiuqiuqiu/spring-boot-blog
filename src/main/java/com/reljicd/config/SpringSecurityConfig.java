...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/home","/stockList", "/registration", "/error", "/blog/**", "/post/**", "/h2-console/**","/upload/**","/api/**").permitAll()
                .antMatchers("/newPost/**", "/commentPost/**", "/createComment/**","/user/**").hasAnyRole("USER")
